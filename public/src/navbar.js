import { setMsg, addClass, getJwtToken, loadingEffect, HOST, FILE_HOST } from './helper.js';
import {
  drawCreateUserForm,
  drawDeleteUserForm,
...
async function drawProfile(e) {
  ...
  pictureDiv.style.backgroundImage = `url(${FILE_HOST}/profile_picture/${userId}.jpg)`;
